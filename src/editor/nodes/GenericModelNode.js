import { StaticModes, setStaticMode } from "../StaticMode";
...
export default class GenericModelNode extends EditorNodeMixin(Model) {
  static nodeName = "Model";

  static componentName = "gltf-model";

  static componentProps = ["collidable", "walkable", "combine"];

  static animationComponentName = "loop-animation";

  static animationComponentProps = ["clip", "activeClipIndices"];
  ...
  serialize(components) {
    ...
    components[this.constructor.componentName] = { src: this._canonicalUrl, attribution: this.attribution };
