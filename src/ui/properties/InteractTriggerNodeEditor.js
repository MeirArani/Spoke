...
export default class InteractTriggerNodeEditor extends Component {
  static propTypes = {
  ...
  static iconComponent = HandPointer;

  static description = "A 3D model that triggers an event";
  ...
  render() {
    ...
    return (
      <NodeEditor description={InteractTriggerNodeEditor.description} {...this.props}>
